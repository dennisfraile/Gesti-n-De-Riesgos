...
<div class="row">
                <div class="col-lg-12">
                     <ol class="breadcrumb">
                          <li>
                              <i class="fa fa-home"></i> <a href="{{url('/activo')}}">Analizar Activos</a>
                          </li>
                          <li class="active">
         ...
         <div class="col-lg-12 pull-left">
               <label><a href="{{url('/activo/create')}}" class="btn btn-success btn-lg" role="button"> <i class="fa fa-plus"></i> Valorar Nuevo Activo</a></label>
        </div>
        <div class="col-lg-12">
			...
			<table class="table table-striped table-bordered table-condensed table-hover" id="tablaperfilpuesto">
               ...
               @foreach ($anactivos as $act)
				<tr>
					...
					<td>{{ $act->riesgo}}</td>
					<td>
						<a href="{{URL::action('AnalisisController@edit',$act->idactivo)}}"><button class="btn btn-xs btn-primary"><i class="glyphicon  glyphicon-edit"></i> Editar</button></a>
